...
| `Baseline - sliver.gpkg`                      | A habitat parcel under the 1 m² minimum area (a 0.9 m square, 0.81 m²) | `sliver`     | `AREA_PARCELS_TOO_SMALL`         |
