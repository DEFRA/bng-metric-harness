...
```sh
python3 development/scale-test-generator/generate.py
...
```sh
python3 development/scale-test-generator/generate.py --fraction 0.12      # -> hs2-phase2a-subsection-12pc/
```
...
```sh
python3 development/scale-test-generator/verify/claim2_nothing_altered.py        # nothing is altered
...
```sh
python3 development/scale-test-generator/verify/summarise.py
```
